...
const Customize = () => {
    ...
    const handleGeneratae=()=>{
        ...
        fetch(`https://iut-hackathon-cv-making-woad.vercel.app/user/recommendation`, {
            method: "POST",
            credentials:"include",
            headers: {
      ...
      <main className=" bg-white px-10 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="mx-auto text-center  w-96">
            ...
            ></textarea>
            <button onClick={handleGeneratae} className="btn btn-active btn-[#0c4a6e]">Generate</button>
          </div>
        </section>
      </main>
    </div>
